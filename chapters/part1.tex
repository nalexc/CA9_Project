...
\section{Simulation and results}
 First the simulation results of the control scheme between two satellites are shown. The angle is chosen to be $60^{o}$. The inputs to the controller are $\theta$ and $\dot{\theta}$ and i order to smooth the high frequency  oscillations from $\theta$ to the controller a low pass filter is used.  
%
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]
