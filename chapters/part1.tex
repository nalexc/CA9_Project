...
The behaviour of the satellite formation was tested hypothesis to the assumption that the satellite formation starts at the same place. From \figref{fig:forr} it can be seen that in the beginning, some saturation appears, but finally, all the satellites converged to the desired angle of 60$^{\circ}$ .
\begin{figure}[H]
	\centering
