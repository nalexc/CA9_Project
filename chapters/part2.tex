...
\end{figure} 
%
In order to choose the value of $\epsilon$ the maximum quaternion error is considered. From the \figref{fig:rel_err} can be seen that the relative error from the polynomial fitting is $- 0,003\textless\tilde{q}\textless0.003$ 