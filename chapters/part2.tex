...
\begin{flalign}
	...
	\label{eq:dq_4}
\end{flalign} 
According to equation \ref{eq:dq_4}, $\vec{\tilde{q}}$ will converge to $[0; 0; 0; 1]$ and $a$ can be designed by trial and error to have the desired convergence. The behaviour of $\tilde{q}_4$ with $D$ equal to 0.035 is represented in the \figref{fig:dq4}. 
\begin{figure}[H]
	\centering
