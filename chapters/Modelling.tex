...
\[
dF_i = -G\frac{m_{earth}}{||R_i||^2}dm_i \cdot \frac{R_i}{||R_i||}
\]
...
\begin{align*}
	...
	&= \int_{sat} r_{g,m} \times -G\frac{m_{earth}}{||R_i||^3}dm_i \cdot {R_i} + \int_{sat} r_{m,i} \times -G\frac{m_{earth}}{||R_i||^3}dm_i \cdot R_i
\end{align*}
...
\[
\Rightarrow N_{gra} = G\frac{m_{sat} \cdot m_{earth}}{||R_{e,g}||^3} \cdot (R_{e,g} \times r_{g,m})
\]
