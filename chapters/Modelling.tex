...
%
\begin{flalign}
	{\frac{d}{dt}(I_{s}{\omega})+\dot{h_{tot}}} ={N_{tot}-\omega}     {\mathrm{x}  ({I_{s}}{\omega} +{h_{tot}})}
...
%
\begin{flalign}
	{\dot{\omega}} ={-I_{s}^{-1}S(\omega)I_{s}^{-1}\omega-I_{s}^{-1}S(\omega)h_{tot}-I_{s}^{-1}\dot{h_{tot}}+I_{s}^{-1}N_{tot}}
